defmodule TeamBuilder.MaxSizeTeamAllocator do
  ...
  defp _assign_teams(number_of_teams, members, max_size, team_number, seed_state) do
    ...
    {selection, remainder, new_seed} = TeamAllocator.members_selection(members, number_of_members_to_select, seed_state)
    with_team_number([selection], team_number) ++ _assign_teams(number_of_teams - 1, remainder, max_size, team_number + 1, new_seed)
  end
